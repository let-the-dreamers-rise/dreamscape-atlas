...
const DreamTimeline = () => {
  ...
  const sorted = [...allDreams].sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime());
                ...
                >
                  ...
                  >
                    <div className="relative h-44 overflow-hidden">
                      <img src={dream.generated_image} alt="" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" />
                    ...
                    <div className="p-5">
                      <div className="flex items-center justify-between mb-2">
                        <h3 className="font-display font-bold text-foreground group-hover:text-primary transition-colors">{dream.title}</h3>
